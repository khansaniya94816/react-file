...
function Hero() {
  ...
  return (
    <main className="flex flex-col lg:flex-row w-full h-auto bg-black text-white">
      ...
      <div className="flex flex-col justify-center items-center lg:items-start w-full lg:w-1/2 px-6 lg:px-20 py-8 lg:py-0">
